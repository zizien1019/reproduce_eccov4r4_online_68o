...
C     PTRACERS_n_d_0    :: number of bins in the dimension of particle size
C     PTRACERS_d_0      :: diameter of clean plastic particles
C     PTRACERS_n_A      :: number of bins in the dimension of Attachment
...
C     PTRACERS_resetPhase   :: Phase (s) to reset ptracers
      ...
      _RL PTRACERS_rho_0
      INTEGER PTRACERS_n_d_0
      _RL PTRACERS_d_0(5)
      INTEGER PTRACERS_n_A
      _RL PTRACERS_delA
      _RL PTRACERS_rFrag
